...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Email', href: 'mailto:support@fitquest.com', icon: Mail },
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Your comprehensive fitness tracking companion. Track workouts, connect with friends, 
              and achieve your fitness goals with advanced analytics and social features.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} FitQuest. All rights reserved.
            </p>
